    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item active"><span>Flat Price Payment</span></li>
          </ol>
        </nav>
    </div>
</header>
      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header bg-secondary d-flex justify-content-between align-items-center">
            <h3 class="text-light">Manage Flat Price Payments</h3>
...
<script>
    const app = Vue.createApp({
        ...
        methods: {
            ...
            fetchAll() {
                axios.get('http://127.0.0.1:8000/api/fetch_all_flatpayments')
