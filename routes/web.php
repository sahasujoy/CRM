...
// Route::get('/customer/get_flats/{building_id}', [CustomerController::class, 'getFlats'])->name('customer.getflats');

// Route::get('/customer/get_flat_size/{flat_id}', [CustomerController::class, 'getFlatSize'])->name('customer.getflatsize');

Route::get('/customer_details/{id}', [CustomerController::class, 'customerDetails'])->name('customer.details');
...
{
    Route::get('/flat_details', [RegistrationController::class, 'flatDetailsView'])->name('registration.flat.details');

    Route::get('/land_details', [RegistrationController::class, 'landDetailsView'])->name('registration.land.details');

    Route::get('/mutation_details', [RegistrationController::class, 'mutationDetailsView'])->name('registration.mutation.details');

    Route::get('/poa_details', [RegistrationController::class, 'poaDetailsView'])->name('registration.poa.details');
});
...
Route::get('/property/bnf_details_view', [PropertyController::class, 'bnfDetailsView'])->name('bnf.details.view');
